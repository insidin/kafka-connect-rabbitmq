...
import static com.github.jcustenborder.kafka.connect.rabbitmq.MessageConverter.basicProperties;
...
public class StringSourceMessageConverter implements SourceMessageConverter {
  ...
  public StringSourceMessageConverter(RabbitMQSourceConnectorConfig config) {
    this.config = config;
  ...
  @Override
  public String key(AMQP.BasicProperties basicProperties) {
